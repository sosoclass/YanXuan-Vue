<template>
  <div class="hot">
    <!--v-for="(topic,index) in item.topics" :key="index"-->
    <div class="w">
      <div class="m-main-content"v-for="(item,index) in data" :key="index">
        <div class="m-tpls wrapper" v-for="(topic,index) in item.topics" :key="index">
          <a href="javascript:;" >
            <div class="u-name">
          <span class="ava">
